...
UCLASS()
class CHAINSAWHOUSE_API APeekPoint : public AActor
{
	GENERATED_BODY()
...
public:
	...
	// Move Errol to this location if bChaseAfterPeek = true.
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	USceneComponent *LeftPeekSpawn = nullptr;
	// Move Errol to this location if bChaseAfterPeek = true.
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	USceneComponent *RightPeekSpawn = nullptr;
