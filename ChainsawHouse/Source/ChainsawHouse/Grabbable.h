...
UCLASS()
class CHAINSAWHOUSE_API AGrabbable : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	// a copy of Mesh because C++ gave me errors (because of same name as BP variable) when I tried to make Mesh a UPROPERTY
	UPROPERTY(BlueprintReadOnly)
	UPrimitiveComponent *BPMesh_GrabSaver = nullptr;
...
public:
	...
	*/
	...
	// Initial translate to apply to the object when gripped so it doesn't look wonky
	void GripTranslate();
